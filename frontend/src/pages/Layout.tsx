...
const APP_URL = 'https://app.teessidemesh.com';
  ...
  <div className="site-layout">
    <nav className="site-nav">
      <Link to="/" className="site-nav__brand" onClick={closeMenu}>
        ...
        <span className="site-nav__name">Teesside Mesh</span>
      </Link>
      ...
      <div className={`site-nav__links${menuOpen ? ' site-nav__links--open' : ''}`}>
        ...
        <NavLink to="/stats" onClick={() => handleNavClick('/stats')} className={({ isActive }) => isActive ? 'site-nav__link site-nav__link--active' : 'site-nav__link'}>
          Stats
        </NavLink>
    ...
    <footer className="site-footer">
      <span>Teesside Mesh Network</span>
